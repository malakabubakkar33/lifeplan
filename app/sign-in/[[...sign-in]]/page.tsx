    ...
    >
      ...
      {isLiveClerk ? (
        ...
        >
          ...
          <form onSubmit={handleDemoSignIn} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
            ...
            >
              <span>Sign In as Alex Morgan</span>
              <ArrowRight size={16} />
            </button>
          ...
          >
            ...
            <Link href="/sign-up" style={{ color: '#19D98A', textDecoration: 'none', fontWeight: 600 }}>
              Sign up
            </Link>
          </div>
        </div>
